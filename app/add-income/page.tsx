...
const defaultIncomeCategories = ["Gaji", "Freelance", "Bisnis", "Investasi", "Bonus", "Lainnya"]
...
export default function AddIncome() {
  ...
  useEffect(() => {
    ...
    if (savedCategories) {
      ...
      setIncomeCategories(categories.income || defaultIncomeCategories)
    }
  }, [])
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="bg-gradient-to-br from-green-600 to-emerald-700 dark:from-green-800 dark:to-emerald-900 text-white p-6">
        <div className="flex items-center mb-6">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold">Tambah Pemasukan</h1>
          </div>
        </div>
      </div>
